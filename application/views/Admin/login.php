...
<?php endif; ?>
	  ...
	  <div id="login-page">
	  	<div class="container">
            ...
            <?php echo form_open('admin/login', array('class' => 'form-login','needs-validation','novalidate' => ''));?>
		      <form>
    ...
    <script type="text/javascript" src="<?php echo base_url('/assets2/js/jquery.backstretch.min.js'); ?>"></script>
    <script>
        $.backstretch("<?php echo base_url('/assets2/img/bg.jpg'); ?>", {speed: 500});
    </script>
